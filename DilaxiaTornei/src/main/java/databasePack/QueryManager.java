...
public class QueryManager {
	...
	private static final String UPDATE_TORNEO = "UPDATE tornei SET ? = ? WHERE (nome_torneo=? AND data_torneo=?)";
	...
	private static final String DELETE_TORNEO = "DELETE FROM tornei WHERE (nome_torneo=? AND data_torneo=?)";
